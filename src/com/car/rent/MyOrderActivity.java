...
public class MyOrderActivity extends Activity   {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myorderViewList = (ListView) findViewById(R.id.myorder_list);
	...
	private void initView() {
		...
		myorderList.clear();
		String url = HttpUtil.BASE_URL +"/servlet/ClientOrderServlet?action=3&username="+login_name;
		...
		try {
			...
			myorderViewList.setAdapter(new Myadapter(MyOrderActivity.this , myorderList));
   						...
   						new DialogInterface.OnClickListener() {
   							public void onClick(DialogInterface dialog, int which) {
   								...
   								case 0: //
   									...
   									Toast.makeText(MyOrderActivity.this, "取消成功", 10).show();
   									initView();
   									break;
